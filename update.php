...
$enpayu=$DB->get_record("enrol_payumoney", array("id" => $id));

$data=new StdClass();
$data->userid           = $enpayu->userid;
$data->courseid         = $enpayu->courseid;
$data->instanceid       = $enpayu->instanceid;
$data->payment_gross    = $enpayu->payment_status;
...
if (is_enrolled($context, $user, '', true)) { // TODO: use real pay check
    redirect(new moodle_url('/course/view.php',array('id'=>$course->id)), get_string('paymentthanks', '', $fullname));
